...
from .collectives import affine_module_weight, _WeightParallelRegion_test
...
class WeightMOELayer(Base):
    ...
    def forward(self, *input: Tensor, **kwargs: Any) -> Tensor:
        ...
        for i in range(self.world_size):
            ...
            expert_outputs = _WeightParallelRegion_test.apply(expert_outputs, self.experts_list[index], self.experts_list[(index+1) % self.world_size], i)
