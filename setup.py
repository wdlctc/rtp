...
if __name__ == "__main__":
    setuptools.setup(
        name="rtp",
        description="RTP: Rotating Tensor Parallelism for Memory Deduplication.",
        version=find_version("rtp/version.py"),
        setup_requires=setup_requires,
        install_requires=fetch_requirements(),
        include_package_data=True,
        packages=setuptools.find_packages(include=["rtp*"]),  # Only include code within rtp.
        ...
        long_description=(
            "RTP is a PyTorch extension library for Memory-efficient "
            "large scale training on one or multiple machines/nodes"
        ),
